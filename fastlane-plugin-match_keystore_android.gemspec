...
require 'fastlane/plugin/match_keystore_android/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-match_keystore_android'
  spec.version       = Fastlane::MatchKeystoreAndroid::VERSION
